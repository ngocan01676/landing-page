        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="form-controls">
                    <textarea type="text" name="news_page_list_sub_title" class="form-control" rows="4">
                        {{setting_item_with_lang('news_page_list_sub_title',request()->query('lang'),$settings['news_page_list_sub_title'] ?? '')}}
                    </textarea>
                    </div>
                </div> -->
                @if(is_default_lang())
