...
Route::group(['prefix'=>config('news.news_route_prefix')],function(){
    ...
    Route::get('/'.config('news.news_location_route_prefix').'/{slug}', 'LocationNewsController@index');
});

Route::post('/blog/client-comment', 'NewsController@clientComment')->name('blogs.clientComment');