        ...
        <div class="panel">
            <div class="panel-body">
                @if(is_default_lang())
                    ...
                    <div class="form-group">
                        <label>{{__('Email receive jobs')}}</label>
                        <div class="form-controls">
                            <input type="text" class="form-control" name="email_receive_jobs" value="{{@$settings['email_receive_jobs'] }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>{{__('Email receive subscriber')}}</label>
                        <div class="form-controls">
                            <input type="text" class="form-control" name="email_receive_subscriber" value="{{@$settings['email_receive_subscriber'] }}">
                        </div>
                    </div>
                @else
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__('Email Header & Footer (send jobs)')}}</h3>
        <p>Support variable:</p>
        <p><?php echo "{{name}}" ?></p>
        <p><?php echo "{{phone}}" ?></p>
        <p><?php echo "{{email}}" ?></p>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label >{{__("Body")}}</label>
                    <div class="form-controls">
                        <textarea name="email_body_content" class="d-none has-ckeditor" data-fullurl="true" cols="30" rows="10">{{setting_item_with_lang('email_body_content',request()->query('lang')) }}</textarea>
                    </div>
                </div>
                <div class="form-group">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__('Email Header & Footer (send subscriber)')}}</h3>
        <p>Support variable:</p>
        <p><?php echo "{{name}}" ?></p>
        <p><?php echo "{{phone}}" ?></p>
        <p><?php echo "{{email}}" ?></p>
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label >{{__("Header")}}</label>
                    <div class="form-controls">
                        <textarea name="email_header_subscriber" class="d-none has-ckeditor" data-fullurl="true" cols="30" rows="10">{{setting_item_with_lang('email_header_subscriber',request()->query('lang')) }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label >{{__("Body")}}</label>
                    <div class="form-controls">
                        <textarea name="email_body_content_subscriber" class="d-none has-ckeditor" data-fullurl="true" cols="30" rows="10">{{setting_item_with_lang('email_body_content_subscriber',request()->query('lang')) }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label >{{__("Footer")}}</label>
                    <div class="form-controls">
                        <textarea name="email_footer_subscriber" class="d-none has-ckeditor" data-fullurl="true" cols="30" rows="10">{{setting_item_with_lang('email_footer_subscriber',request()->query('lang')) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
