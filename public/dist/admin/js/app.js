...
(function ($) {
  ...
  $('.has-ckeditor').each(function () {
    ...
    tinymce.init({
      ...
      toolbar: 'formatselect | bold italic strikethrough forecolor backcolor permanentpen formatpainter | link image media | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | pagebreak codesample code | removeformat | code',
      image_advtab: true,
      image_caption: true,
      ...
      file_picker_callback: function file_picker_callback(callback, value, meta) {
        ...
        if (meta.filetype === 'image') {
          uploaderModal.show({
            ...
            file_type: 'image',
            onSelect: function onSelect(files) {
              console.log(" files files23232", files);
              if (files.length) callback(files[0].full_size);
            }
          });
        }
    ...
    methods: {
      ...
      sendFiles: function sendFiles() {
        if (typeof this.onSelect == 'function') {
          var f = this.onSelect;
          console.log("this.selectedLists this.selectedLists", this.selectedLists)
          console.log("f f f", f)
  ...
  Vue.component('file-item', {
    ...
    methods: {
      ...
      getFileThumb: function getFileThumb(file) {
        ...
        if (file.file_type.substr(0, 5) == 'image') {
          return '<img src="' + file.medium_size + '">';
        }
...
__webpack_require__(/*! C:\xampp\htdocs\Apec\hr-website\resources\admin\js\app.js */"./resources/admin/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\Apec\hr-website\resources\admin\scss\vendors.scss */"./resources/admin/scss/vendors.scss");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Apec\hr-website\resources\admin\scss\app.scss */"./resources/admin/scss/app.scss");
