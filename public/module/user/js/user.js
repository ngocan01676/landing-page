...
jQuery(function ($) {
    ...
    $('.has-ckeditor').each(function () {
        ...
        tinymce.init({
            ...
            toolbar: 'formatselect | bold italic strikethrough forecolor backcolor permanentpen formatpainter | link image media | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | pagebreak codesample | removeformat | code',
            image_advtab: true,
            image_caption: true,
